...
struct Make: ParsableCommand {
    static let configuration = CommandConfiguration(abstract: "Gatsby blog template maker")
    ...
    @Option(name: .shortAndLong, help: "Content type. Possible values: \(values)")
...
"""
        ...
        print("✅ The new file has been created at:\n".foregroundColor(.orange1))
